...
public partial class AppointmentsViewMobile : UserControl
{
    ...
    private void DrawUI()
    {
        ...
        {
            if (app.StartTime.Date != DateTime.Today) continue;
            ...
            innerGrid.RowDefinitions.Add(new RowDefinition(GridLength.Auto)); // name + btns
            innerGrid.RowDefinitions.Add(new RowDefinition(GridLength.Star)); // service & comment
            ...
            // --- service & comment ---
            var middleStack = new StackPanel { VerticalAlignment = Avalonia.Layout.VerticalAlignment.Center, Margin = new Thickness(0, 5) };
            middleStack.Children.Add(new TextBlock { Text = app.ServiceName, FontSize = 13, Foreground = Brushes.White, Opacity = 0.9 });
